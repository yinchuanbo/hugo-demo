---
title: "前端性能优化—渲染优化"
date: 2022-10-11T21:07:57+08:00
---
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/74651fadf3d147dab65e24e7f4b69448~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/efc98430bb11487baba0bf4adaf81298~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

## 2\. 资源的合并和压缩

`web`前端应用的开发与部署过程：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1a35c77981b14c4b9276ed04facdccea~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

输入`url`到页面显示出来的过程

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/98babaadf46e404bafb72f3c69172ffd~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
`google`的流量，占到整个互联网的`40%`，如果`2016`年全球网络流量是`1.3ZB(1ZB = 10^9TB)`，那么`google`在`2016`年的流量就是`1.3ZB * 40%`，如果`google`每`1MB`请求减少一个字节，每年可以节省流量近`500TB`流量。
...
- 使用在线网站进行压缩：[tool.oschina.net/jscompress/](https://tool.oschina.net/jscompress/)
- ![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7c000f960fbf46be86e179ece8ceead1~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ff8d8a6de9ee493abd96c15a138b4d73~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ff85f0071acd475aa0c3fe64e0207049~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

这里提供一个将：`image`  转  `DataUrI`的网址：[tool.c7sky.com/datauri/](http://tool.c7sky.com/datauri/)

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f9174198d74048779854012751151a35~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/32034866c3f54564a72c67562da90d6d~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a565d945483e455db94eb6d0b8cac1ff~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

可以通过在线网站将图片转换为`webp`：[zhitu.isux.us/](https://zhitu.isux.us/)

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4bb788a18d754a4b997cda5a6e958dae~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
### 3.8 矢量图`SVG`与`iconfont`

使用`iconfont`解决`icon`问题

应尽量使用该方式，比如可以采用阿里巴巴矢量图库：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f0dde917dc2c4c31bb484dd40c0c7447~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

可以选择格式进行下载：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/649daf1ef227435d88d48d06bb3c94a6~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

\\

可以看到它们的大小有着明显的差异：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bac978c1e8d54a73b95206bb02b90026~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

使用`SVG`进行矢量图的控制

`SVG` 意为可缩放矢量图形（`Scalable Vector Graphics`）。`SVG`  使用  `XML`  格式定义图像。下为示例：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f6fc6016db7746219b72b36c68f8f967~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

在线转换网站：[www.bejson.com/convert/ima…](http://www.bejson.com/convert/image_to_svg/)

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3416867dfc5e46b4be17b3b36041553a~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/90c3c5a7073b40a38ed069b01c4f3859~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

很多情况下，并不是所有的小图标都放在一张雪碧图中，而是会适当进行拆分。现在使用雪碧图的场景比较少了。

自动生成雪碧图样式的网站：[www.spritecow.com/](http://www.spritecow.com/)

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3077091e1d1a4e1b8614337a8fac11b2~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7e67d340cfb14d238acbf2de96397019~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

举例

比如手机淘宝首页：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5ed146b451084f89ad3c331bed45449f~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)

当快要滚动到需要展示的图片时才进行图片的请求，可以看到图片上有一个`lazyload`的属性：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9f928ccd0b834f3287a5710ffa5c329d~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d25b621004e144d08135aa89c58c640c~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
...
- 动画优化：
- 尽量使用 CSS3 动画
- 合理使用 `requestAnimationFrame` 动画代替 `setTimeout` （跑在主线程上，一般一秒刷新 60 次，提高动画帧的利用效率），参考文章 [requestAnimationFrame & CSS3 animation](https://link.jianshu.com?t=http://www.zhangxinxu.com/wordpress/2013/09/css3-animation-requestanimationframe-tween-%E5%8A%A8%E7%94%BB%E7%AE%97%E6%B3%95/)；
- 适当使用 Canvas 动画， 5 个元素以内使用 CSS 动画（IOS8 可使用 webGL）；
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d08368edf1ad4810bf883e7316690f37~tplv-k3u1fbpfcp-zoom-in-crop-mark:4536:0:0:0.awebp)
